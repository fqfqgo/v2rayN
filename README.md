...
Windows 用户若不方便解压 zip，可下载同版本的 `*-Setup.exe`：它会解压到当前用户目录 `%LocalAppData%\Programs\v2rayN`，创建桌面快捷方式，并登记当前用户卸载信息；不写入系统目录。
...
```text
A4A6 9C43 2C53 2A5F 21D0
B6EE 1416 2A20 9ADA 306B
```
