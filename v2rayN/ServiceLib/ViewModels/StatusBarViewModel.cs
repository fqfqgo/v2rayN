...
public partial class StatusBarViewModel : MyReactiveObject
{
    ...
    [Reactive]
    public partial bool BlConnectionOn { get; set; }

    [Reactive]
    public partial string ConnectionButtonText { get; set; } = string.Empty;

    [Reactive]
    public partial bool BlStartConnectionEnabled { get; set; } = true;

    public ReactiveCommand<RxVoid, RxVoid> StartConnectionCmd { get; }
