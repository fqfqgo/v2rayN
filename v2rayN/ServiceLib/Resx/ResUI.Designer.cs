...
namespace ServiceLib.Resx {
    ...
    public class ResUI {
        ...
        /// <summary>
        ///   查找类似 Subscription decryption failed 的本地化字符串。（我方）
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Enter subscription link here 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Show Password 的本地化字符串。（我方）
        /// </summary>
        public static string TbShowPassword {
            get {
                return ResourceManager.GetString("TbShowPassword", resourceCulture);
            }
        }
